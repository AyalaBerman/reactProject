...
const BussinessDetails = observer(() => {
    ...
    const dialog = () => (
        <Dialog open={toEdit} onClose={handleClose} sx={{ minWidth: 275, textAlign: 'center', alignContent: 'cenetr', alignItems: "center", direction: 'rtl' }}>
            <DialogTitle sx={{ color: "orange" }}>עדכן פרטי עסק</DialogTitle>
            <DialogContent >
                <DialogContentText>
                ...
                <form onSubmit={handleSubmit(saveDetails)} sx={{ direction: 'rtl' }}>
                    ...
                    <DialogActions sx={{ minWidth: 275, textAlign: 'center', alignContent: 'cenetr', alignItems: "center" }}>
                        <Button size="medium" type='submit' variant="contained" sx={{ backgroundColor: 'orange', margin: "1em" }} onClick={handleClose}>ביטול</Button>
                        <Button size="medium" type='submit' variant="contained" sx={{ backgroundColor: 'orange', margin: "1em" }} >שמירה</Button>
                    </DialogActions>
                </form>
            </DialogContent>
        </Dialog >)
        ...
        <Grid container
            ...
            <Grid
                ...
                >
                    ...
                    <ListItem>
                        {useContext(ModeContext).isAdmin && <Button sx={{ backgroundColor: 'orange' }} size="small" width="50%" variant="contained" onClick={() => { setToEdit(true) }}>עדכון</Button>}
                    </ListItem>
