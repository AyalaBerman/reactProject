                    ...
                    ><Box sx={{ width: '50%' }}>
                            <Card sx={{ minWidth: 275, textAlign: 'center', alignContent: 'cenetr', alignItems: "center" }} >
                                <form onSubmit={handleSubmit}>
                                    <Typography sx={{ color: "orange" }}>לכניסה כמנהל יש להזין שם משתמש וסיסמה</Typography>
                                    ...
                                    <CardContent><Button size="large" type='submit' variant="contained" sx={{ backgroundColor: 'orange' }}>התחבר</Button></CardContent>
