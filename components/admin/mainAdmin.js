...
export default function MainAdmin() {
    ...
    return (<div sx={{ AlignItems: 'center' }}>
        ...
        <Grid container
            ...
            alignItems="center"
            alignContent="center"
            > <Button sx={{margin:'1em', backgroundColor:'gray'}} size="small" width="50%" variant="contained" onClick={changeToServices}>שירותי עסק</Button>
            <Button  sx={{margin:'1em', backgroundColor:'gray'}} size="small" width="50%" variant="contained" onClick={changeToAppointments}>פגישות</Button></Grid>
