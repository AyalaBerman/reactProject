    ...
    const dialog = () => (<Grid 
        ...
        alignContent="center"><Dialog open={open} onClose={handleCancel}> 
            <DialogActions sx={{alignContent:"center", justifyContent:"center"}}>
                <Button size="small" variant="contained" sx={{ color: 'orange', backgroundColor: "white" }} onClick={handleCancel}><CancelIcon></CancelIcon></Button>
            </DialogActions>
            <DialogTitle textAlign="center" color="orange" >הזמנת פגישה</DialogTitle>
            <Grid Grid
                container
                direction="column"
                justifyContent="center"
